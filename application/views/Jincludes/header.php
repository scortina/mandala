              ...
              <div class="container-fluid">
                  ...
                  <ul class="nav pull-right">
                      <li class="dropdown user">
                        ...
                        <li>
                            <a href="<?php echo site_url('user/configuracion/edit/'.$this->session->userdata('user_id'))?>"><i class="icon-cog"></i> Configuración</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('user/logout')?>"><i class="icon-off"></i> Salir</a>
                        </li>
                      </ul>
                    </li>
                  </ul>
