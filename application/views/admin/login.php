...
<head>
	<meta charset="utf-8" />
	<title>Mandala</title>
	<link rel="apple-touch-icon" href="<?php echo $this->config->base_url();?>assets/img/logo.png"/>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $this->config->base_url();?>assets/plugins/select2/select2_metro.css" />
	<!-- END GLOBAL MANDATORY STYLES -->
	<!-- BEGIN PAGE LEVEL STYLES -->
    <link href="<?php echo $this->config->base_url();?>assets/css/pages/login-soft-rtl.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="<?php echo site_url('user/validate_credentials')?>" method="post">
			<div class="alert alert-error hide">
				<button class="close" data-dismiss="alert"></button>
				<span>Ingrese el usuario y password.</span>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" autocomplete="off" placeholder="Clave" name="password"/>
					</div>
				</div>
			</div>
	...
	<script src="<?php echo $this->config->base_url();?>assets/plugins/bootstrap/js/bootstrap-rtl.min.js" type="text/javascript"></script>
	...
	<script src="<?php echo $this->config->base_url();?>assets/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
    ...
    <script src="<?php echo $this->config->base_url();?>assets/scripts/login-soft.js" type="text/javascript"></script>  
