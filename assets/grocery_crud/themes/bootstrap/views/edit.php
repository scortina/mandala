...
<div class="crud-form" data-unique-hash="<?php echo $unique_hash; ?>">
    <div class="gc-container container">
        <div class="row">
            <div class="col-md-12">
...
<script>
    ...
    var jose = document.getElementsByTagName('input');//.className = "form-control";
    //console.log(jose.length);
    for(i = 0; i < jose.length; i++ ){
         jose[i].className = "form-control";
    }
</script>