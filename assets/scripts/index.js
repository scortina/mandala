    ...
    return {
        ...
        initDashboardDaterange: function () {
            ...
            function (start, end) {
                ...
                $('#dashboard-report-range span').html(start.toString('yyyy-MM-dd') + ' AL ' + end.toString('yyyy-MM-dd'));
				//Cargar todos los dashboard
				//WHERE `fecha` >= '2014-09-02 00:00:00'
				//graficar_todo();
            });
            ...
            $('#dashboard-report-range span').html(Date.today().add({
                days: -0
            }).toString('yyyy-MM-dd') + ' AL ' + Date.today().toString('yyyy-MM-dd'));
        },
